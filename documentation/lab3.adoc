...
Go to Ansible Automation Platform and execute the Job Template of **Lab3_config_win10_vm**:
...
But first we need to download and install the Jumbo Hotfix Accumulator and enable the API to be able to use the latest modules from Ansible (executed in Ansible Automation Platform).
...
link:lab2.adoc[Previous Section -> Lab 2: Deploying the DevSecOps environment in Azure with Ansible Automation Platform]
